...
function SerieEditFormPage(){
    ...
    const onChangeImage = (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setData({ ...data, img: reader.result }); // Guardar la imagen en base64
            };
                ...
                <form onSubmit={handleSubmit} className="row">
                    <div className="col-md-4">
                        <img 
                            ...
                            src={data.img ? data.img : "https://dummyimage.com/400x250/000/fff"}
                            alt="img" />
                    </div>
                    <div className="col-md-8">
                        ...
                        <div className="mb-3">
                            ...
                            <input type="file" className="form-control" id="inputImage" onChange={onChangeImage}/>
                        </div>
                        <div className="mb-3">
